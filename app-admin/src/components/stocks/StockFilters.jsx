            ...
            <View className="mb-6">
              <View className={`flex-row items-center justify-between p-4 rounded-xl ${
                ...
                <Switch
                  ...
                  onValueChange={(value) => handleFilterChange("lowStock", value)}
              ...
              <View className="flex-row gap-3">
                <View className="flex-1">
                  ...
                  <TextInput
                    ...
                    onChangeText={(value) => handleFilterChange("minQuantity", value)}
                    placeholder="0"
                ...
                <View className="flex-1">
                  ...
                  <TextInput
                    ...
                    onChangeText={(value) => handleFilterChange("maxQuantity", value)}
                    placeholder="Any"
                    placeholderTextColor={isDarkMode ? '#6B7280' : '#9ca3af'}
                    keyboardType="numeric"
                    className={`rounded-xl px-4 py-3 border ${
