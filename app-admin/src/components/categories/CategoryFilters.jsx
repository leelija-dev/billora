        ...
        <View className={`rounded-t-3xl max-h-[90%] ${
          ...
          >
            ...
            <View className="mb-6">
              ...
              <View className="flex-row gap-2">
                <TouchableOpacity
                  onPress={() => handleFilterChange("hasProducts", null)}
                  className={`flex-1 py-3 px-3 rounded-xl ${
                    filters.hasProducts === null
                      ? "bg-blue-500"
                      : isDarkMode ? 'bg-gray-700' : 'bg-gray-200'
                  }`}
                >
                ...
                <TouchableOpacity
                  onPress={() => handleFilterChange("hasProducts", true)}
                  className={`flex-1 py-3 px-3 rounded-xl ${
                ...
                <TouchableOpacity
                  onPress={() => handleFilterChange("hasProducts", false)}
                  className={`flex-1 py-3 px-3 rounded-xl ${
