    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950">
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-red-600 dark:text-red-400 mb-3">Error Loading Invoice</h2>
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950">
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-gray-600 dark:text-gray-400 mb-3">Invoice Not Found</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-8">The requested invoice could not be found.</p>
          <Button onClick={() => navigate('/invoices')} variant="outline" className="gap-2">
            <FiArrowLeft className="w-4 h-4" />
            Back to Invoices
          </Button>
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                >
                  ...
                  <div className="relative p-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="space-y-1">
                        <p className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Customer Name</p>
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="flex items-center gap-2">
                          <FiPhone className="w-4 h-4 text-gray-400" />
                          <p className="text-sm text-gray-700 dark:text-gray-300">{invoice.customer_phone}</p>
                        </div>
                      </div>
                      <div className="space-y-1">
                        <p className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Email</p>
                        <div className="flex items-center gap-2">
                          <FiMail className="w-4 h-4 text-gray-400" />
                          <p className="text-sm text-gray-700 dark:text-gray-300">{invoice.customer_email}</p>
                        </div>
                      </div>
                      <div className="space-y-1">
                        <p className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">GST Number</p>
                        <p className="font-mono text-sm text-gray-700 dark:text-gray-300">{invoice.customer_gst || 'N/A'}</p>
                      </div>
                      <div className="sm:col-span-2 space-y-1">
                        <p className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Address</p>
                        <div className="flex items-start gap-2">
                          <FiHome className="w-4 h-4 text-gray-400 mt-0.5 flex-shrink-0" />
                          <p className="text-gray-700 dark:text-gray-300">{invoice.customer_address}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <table className="w-full">
                      <thead className="bg-gray-50 dark:bg-gray-700/50">
                        <tr>
                          ...
                          <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Item Details</th>
                          <th className="px-6 py-4 text-right text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Qty</th>
                          <th className="px-6 py-4 text-right text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Price</th>
                          <th className="px-6 py-4 text-right text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">GST</th>
                          <th className="px-6 py-4 text-right text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Discount</th>
                        ...
                        {invoice.items && invoice.items.length > 0 && (
                          <>
                            ...
                            {invoice.items.map((item, index) => {
                              ...
                              return (
                                <tr key={`product-${index}`} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                  ...
                                  <td className="px-6 py-4 whitespace-nowrap text-sm text-right text-gray-900 dark:text-white">{formatCurrency(itemPrice)}</td>
                                  <td className="px-6 py-4 whitespace-nowrap text-sm text-right text-gray-900 dark:text-white">{itemGst || 0}%</td>
                                  <td className="px-6 py-4 whitespace-nowrap text-sm text-right text-green-600 dark:text-green-400">{itemDiscount || 0}%</td>
                                  <td className="px-6 py-4 whitespace-nowrap text-sm text-right font-bold text-blue-600 dark:text-blue-400">{formatCurrency(itemTotal)}</td>
                                </tr>
                              );
                            })}
                          </>
                        ...
                        {invoice.packages && invoice.packages.length > 0 && (
                          <>
                            <tr className="bg-gray-50/50 dark:bg-gray-800/50">
                              <td colSpan="7" className="px-6 py-3">
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">Packages</span>
                                </div>
                              </td>
                            </tr>
                            {invoice.packages.map((pkg, index) => {
                              ...
                              return (
                                <tr key={`package-${index}`} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-500 dark:text-gray-400">{startIndex + index + 1}</td>
                                  <td className="px-6 py-4 whitespace-nowrap">
                                    <div className="flex items-center gap-2">
                                      ...
                                      <div>
                                        <span className="font-medium text-gray-900 dark:text-white">{pkg.package_name || `Package #${pkg.package_id}`}</span>
                                        {pkg.package_size && (
                                  ...
                                  <td className="px-6 py-4 whitespace-nowrap text-sm text-right text-gray-900 dark:text-white">{formatCurrency(pkgPrice)}</td>
                                  <td className="px-6 py-4 whitespace-nowrap text-sm text-right text-gray-500">—</td>
                                  <td className="px-6 py-4 whitespace-nowrap text-sm text-right text-gray-500">—</td>
                                  <td className="px-6 py-4 whitespace-nowrap text-sm text-right font-bold text-purple-600 dark:text-purple-400">{formatCurrency(pkgTotal)}</td>
                                </tr>
                              );
                            })}
                          </>
                  ...
                  <div className="p-6">
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-semibold text-green-600 dark:text-green-400 text-lg">{formatCurrency(paidAmountNum)}</span>
                      </div>

                      {paidAmountNum > totalAmountNum ? (
                        <div className="flex justify-between items-center pt-3 border-t border-gray-100 dark:border-gray-700">
                          <span className="text-gray-600 dark:text-gray-400">Change Returned</span>
                          <span className="font-semibold text-blue-600 dark:text-blue-400">{formatCurrency(paidAmountNum - totalAmountNum)}</span>
                        </div>
                      ) : paidAmountNum < totalAmountNum && invoice.status !== 'cancelled' ? (
                        <div className="flex justify-between items-center pt-3 border-t border-gray-100 dark:border-gray-700">
                          <span className="text-gray-600 dark:text-gray-400">Due Amount</span>
                          <span className="font-semibold text-orange-600 dark:text-orange-400 text-lg">{formatCurrency(dueBalance)}</span>
                        </div>
                      ) : null}
                    </div>
