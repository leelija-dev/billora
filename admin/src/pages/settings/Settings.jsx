...
import { 
  FiUser, FiBell, FiLock, FiGlobe, FiSave, FiDownload, FiShare2, 
  FiShield, FiMoon, FiSun, FiSmartphone, FiCheck, FiCopy,
  FiZoomIn, FiMail, FiShoppingBag, FiAlertCircle
} from 'react-icons/fi'
...
const Settings = () => {
  ...
  const { theme, toggleTheme } = useUIStore() // Get theme and toggleTheme from UI store
  ...
  const tabs = [
    { id: 'profile', name: 'Profile', icon: FiUser, description: 'Manage your personal info' },
    { id: 'notifications', name: 'Notifications', icon: FiBell, description: 'Set your preferences' },
    { id: 'security', name: 'Security', icon: FiLock, description: 'Protect your account' },
    { id: 'preferences', name: 'Preferences', icon: FiGlobe, description: 'Customize experience' },
    { id: 'qr', name: 'QR Code', icon: FaQrcode, description: 'Share your store' },
  ]
            ...
            <AnimatePresence mode="wait">
              ...
              {activeTab === 'profile' && (
                <SettingCard key="profile">
                  <div className="p-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-primary-50 to-transparent dark:from-primary-900/20">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Update your personal details and contact information</p>
                  </div>
              ...
              {activeTab === 'notifications' && (
                <SettingCard key="notifications">
                  ...
                  <div className="p-6 space-y-6">
                    {[
                      { key: 'emailNotifications', icon: FiMail, title: 'Email Notifications', description: 'Receive email notifications for important updates' },
                      { key: 'orderUpdates', icon: FiShoppingBag, title: 'Order Updates', description: 'Get notified when orders are placed or updated' },
                      { key: 'lowStockAlerts', icon: FiAlertCircle, title: 'Low Stock Alerts', description: 'Receive alerts when products are running low' },
                    ].map((item) => (
                      <motion.div
                        key={item.key}
                      ...
                      >
                        ...
                        <label className="relative inline-flex items-center cursor-pointer">
                          <input
                            ...
                            onChange={(e) => setNotifications({ [item.key]: e.target.checked })}
                          />
              ...
              {/* Security Tab */}
              {activeTab === 'security' && (
                <SettingCard key="security">
                  <div className="p-6 border-b border-gray-200 dark:border-gray-700">
                    <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Security Settings</h2>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Protect your account with strong security</p>
                  </div>
              ...
              {activeTab === 'preferences' && (
                <SettingCard key="preferences">
                  ...
                  <div className="p-6 space-y-5">
                    ...
                    {/* Fixed Dark Mode Toggle - Now connected to actual theme */}
                    <div className="pt-4">
                      <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl">
                        ...
                        >
                          <div className={`w-11 h-6 rounded-full transition-colors duration-200 ease-in-out ${
                            ...
                            <div className={`absolute top-[2px] left-[2px] bg-white rounded-full h-5 w-5 transition-transform duration-200 ease-in-out flex items-center justify-center ${
              ...
              {activeTab === 'qr' && (
                <SettingCard key="qr">
                  <div className="p-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-primary-50 to-transparent dark:from-primary-900/20">
                    <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Store QR Code</h2>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Share your store with customers via QR code</p>
                  </div>
                    ...
                    {user?.products_qr ? (
                        ...
                        <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-800">
                          <div className="flex items-start space-x-3">
                            ...
                            <div className="text-left">
                              <h4 className="text-sm font-medium text-blue-900 dark:text-blue-300">Pro Tip</h4>
                              <p className="text-xs text-blue-700 dark:text-blue-400 mt-1">
                                Print this QR code and display it at your store counter for customers to scan and browse products online.
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="text-center py-12">
                        ...
                        <p className="text-gray-500 dark:text-gray-400 max-w-md mx-auto">
                          Start adding products to your store to generate a unique QR code that customers can scan to view your catalog.
                        </p>
                      </div>
                    )}
                  </div>
          ...
          >
            ...
            >
              <div className="relative bg-gradient-to-r from-primary-500 to-primary-600 p-6 text-white">
                ...
                <p className="text-primary-100 text-sm mt-1">Scan to view products</p>
              </div>
              ...
              <div className="p-6 border-t border-gray-200 dark:border-gray-700 flex justify-center space-x-3">
                <Button variant="outline" size="sm" onClick={downloadQRCode} className="rounded-lg">
                  Download
                </Button>
                <Button variant="outline" size="sm" onClick={shareQRCode} className="rounded-lg">
                  Share
                </Button>
              </div>
            </motion.div>
