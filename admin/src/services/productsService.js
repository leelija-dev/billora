...
export const productsAPI = {
  ...
  getDeleted: async (userId = null, search = "") => {
    try {
      ...
      const response = await apiClient.get(
        `/products/deleted-products/${userId}`,
        { params },
      );
  ...
  create: async (productData) => {
    try {
      ...
      if (productData.unit_amount)
        formData.append("unit_amount", productData.unit_amount);
      ...
      if (productData.created_by)
        formData.append("created_by", productData.created_by);
      ...
      if (productData.purchase_gst_percentage)
        formData.append(
          "purchase_gst_percentage",
          productData.purchase_gst_percentage,
        );
      ...
      if (productData.conversion_factor)
        formData.append("conversion_factor", productData.conversion_factor);
      if (productData.minimum_stock_quantity)
        formData.append(
          "minimum_stock_quantity",
          productData.minimum_stock_quantity,
        );
      if (productData.maximum_stock_quantity)
        formData.append(
          "maximum_stock_quantity",
          productData.maximum_stock_quantity,
        );
      ...
      if (productData.gst_hsn_code)
        formData.append("gst_hsn_code", productData.gst_hsn_code);
      if (productData.discount_amount)
        formData.append("discount_amount", productData.discount_amount);
      if (productData.cess_percentage)
        formData.append("cess_percentage", productData.cess_percentage);
      ...
      if (productData.medicine_type_id)
        formData.append("medicine_type_id", productData.medicine_type_id);
      if (productData.other_medicine_type)
        formData.append("other_medicine_type", productData.other_medicine_type);
      if (productData.expiry_date)
        formData.append("expiry_date", productData.expiry_date);
      if (productData.batch_number)
        formData.append("batch_number", productData.batch_number);
      if (productData.manufacturer_name)
        formData.append("manufacturer_name", productData.manufacturer_name);
      if (productData.prescription_required)
        formData.append(
          "prescription_required",
          productData.prescription_required,
        );
      if (productData.schedule_type)
        formData.append("schedule_type", productData.schedule_type);
      if (productData.salt_composition)
        formData.append("salt_composition", productData.salt_composition);
      if (productData.perishable)
        formData.append("perishable", productData.perishable);
      if (productData.organic_certified)
        formData.append("organic_certified", productData.organic_certified);
      if (productData.harvest_date)
        formData.append("harvest_date", productData.harvest_date);
      if (productData.storage_instructions)
        formData.append(
      ...
      if (productData.is_returnable)
        formData.append("is_returnable", productData.is_returnable);
      if (productData.is_refundable)
        formData.append("is_refundable", productData.is_refundable);
      if (
        productData.warranty_months !== undefined &&
        productData.warranty_months !== null &&
        productData.warranty_months !== "" &&
        !isNaN(productData.warranty_months)
      ) {
        formData.append("warranty_months", productData.warranty_months);
      }
      if (productData.warehouse_location)
        formData.append("warehouse_location", productData.warehouse_location);
      if (productData.supplier_id)
        formData.append("supplier_id", productData.supplier_id);
      if (productData.updated_by)
        formData.append("updated_by", productData.updated_by);
      // Handle single image
      ...
      // Handle multiple images - ALWAYS send images array
  ...
  update: async (id, productData) => {
    try {
      ...
      if (hasNewImages) {
        ...
        if (productData.manufacturer_name)
          formData.append("manufacturer_name", productData.manufacturer_name);
        if (productData.prescription_required !== undefined)
          formData.append(
            "prescription_required",
            productData.prescription_required,
          );
        ...
        if (productData.salt_composition)
          formData.append("salt_composition", productData.salt_composition);
        if (productData.perishable !== undefined)
          formData.append("perishable", productData.perishable);
        if (productData.organic_certified !== undefined)
          formData.append("organic_certified", productData.organic_certified);
        if (productData.harvest_date)
          formData.append("harvest_date", productData.harvest_date);
        if (productData.storage_instructions)
        ...
        if (productData.is_featured !== undefined)
          formData.append("is_featured", productData.is_featured);
        if (productData.is_returnable !== undefined)
          formData.append("is_returnable", productData.is_returnable);
        if (productData.is_refundable !== undefined)
          formData.append("is_refundable", productData.is_refundable);
        if (
          productData.warranty_months !== undefined &&
          productData.warranty_months !== null &&
