                ...
                <tbody>
                    @if (isset($contacts) && count($contacts) > 0)
                        @foreach ($contacts as $contact)
                            <tr class="{{ $contact['view_status'] == 0 ? 'bg-blue-50' : '' }}">
                                <td>
                                    <div style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
                                        <input type="checkbox" name="select_contact[]" value="{{ $contact['id'] }}" class="contact_checkbox" onclick="updateSelectionCount()">
                                ...
                                <td>
                                    <div class="customer-info-modern">
                                        ...
                                        <div class="customer-details-modern">
                                            <span class="customer-name-modern {{ $contact['view_status'] == 0 ? 'font-semibold' : '' }}">
                                                {{ $contact['name'] }}
                                            </span>
