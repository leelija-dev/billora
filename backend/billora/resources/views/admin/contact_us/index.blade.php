            ...
            <div class="stats-grid-modern">
                <div class="stat-card-modern">
                    ...
                    <div class="stat-icon-modern">
                        <svg viewBox="0 0 24 24">
                            <path
                                d="M20 2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h4v2c0 .55.45 1 1 1h.59c.26 0 .52-.11.71-.29L14.59 18H20c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z" />
                        </svg>
                    </div>
                </div>
                <div class="stat-card-modern">
                ...
                <div class="search-results-info">
                    <div class="search-results-badge">
                        ...
                        <a href="{{ route('admin.contacts.index') }}"
                            style="margin-left: 12px; color: #2563eb; text-decoration: none;">Clear search</a>
                    </div>
                </div>
            @endif
                    ...
                    <thead>
                        <tr>
                            <th style="width: 60px; text-align: center;">
                                ...
                                <label for="select_all" class="checkbox-label" style="margin-left: 4px;">All</label>
                            </th>
                    ...
                    <tbody>
                        @if (isset($contacts) && count($contacts) > 0)
                            @foreach ($contacts as $contact)
                                <tr class="{{ $contact['view_status'] == 0 ? 'bg-blue-500' : '' }}">
                                    <td>
                                        <div style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
                                            <input type="checkbox" name="select_contact[]" value="{{ $contact['id'] }}"
                                                class="contact_checkbox" onclick="updateSelectionCount()">
                                    ...
                                    <td>
                                        <div class="customer-info-modern">
                                            ...
                                            <div class="customer-details-modern">
                                                <span
                                                    class="customer-name-modern {{ $contact['view_status'] == 0 ? 'font-semibold' : '' }}">
                                                    {{ $contact['name'] }}
                                                </span>
                                                <span class="customer-email-modern">
                                                    {{ $contact['email'] }}
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <td class="text-center">
                                        {{ \Illuminate\Support\Str::limit($contact['subject'], 35, '...') ?? $contact['subject'] }}
                                    </td>
                                    <td class="text-center">
                                        {{ \Illuminate\Support\Str::limit($contact['message'], 35, '...') ?? $contact['message'] }}
                                    </td>
                                    <td class="text-center">
                                    ...
                                    <td class="text-center">
                                        <div class="action-buttons-modern">
                                            <a href="{{ route('admin.contacts.view', $contact->id) }}">
                                                <button class="action-btn-modern" title="View Message">
                                                    <svg viewBox="0 0 24 24">
                                                        <path
                                            ...
                                            <a href="{{ route('admin.contacts.send-mail', $contact->id) }}">
                                                <button class="mail-btn-modern" title="Send Reply">
            ...
            @if ($contacts->hasPages())
                <div class="pagination-modern">
                    <div class="pagination-info">
                        Showing <strong>{{ $contacts->firstItem() }}</strong> to
                        <strong>{{ $contacts->lastItem() }}</strong> of <strong>{{ $contacts->total() }}</strong> results
                    </div>
                    <div>
