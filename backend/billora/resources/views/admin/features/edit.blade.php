    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <div class="header-left">
                <h1>Edit Features</h1>
                <p>Update the details of your features</p>
            </div>
        ...
        <div class="form-container">
            <form id="featureForm" action="{{ route('admin.features.update', $feature->id) }}" method="POST" novalidate>
                @csrf
                ...
                <div class="form-group">
                        ...
                        <div >
                            ...
                            <input type="text" name="name" class="form-input"
                                placeholder="Enter feature name" value="{{ old('name') ?? $feature->name }}"
                                required>
                            @error('name')
