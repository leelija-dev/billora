        ...
        <div class="modern-card">
            ...
            <div class="stats-grid-modern">
                <div class="stat-card-modern">
                    ...
                    <!-- BLUE -->
                    <div class="stat-icon-modern bg-blue-100 text-blue-600 flex items-center justify-center rounded-xl w-14 h-14"
                        style="background: #dbeafe; color: #2563eb;">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7" fill="none" style="fill: #2563eb;"
                ...
                <div class="stat-card-modern">
                    ...
                    <!-- GREEN -->
                    <div class="stat-icon-modern bg-green-100 text-green-600 flex items-center justify-center rounded-xl w-14 h-14"
                        style="background: #d1fae5; color: #10b981;">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7" fill="none" viewBox="0 0 24 24"
                            style="fill: #10b981;" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M19 21H9a2 2 0 01-2-2V5a2 2 0 012-2h7l5 5v11a2 2 0 01-2 2z" />
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 3v5h5" />
                        </svg>
                ...
                <div class="stat-card-modern">
                    ...
                    <!-- WARNING / YELLOW -->
                    <div class="stat-icon-modern bg-yellow-100 text-yellow-600 flex items-center justify-center rounded-xl w-14 h-14"
                        style="background: #fef3c7; color: #f59e0b;">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7" fill="none" viewBox="0 0 24 24"
                            style="fill: #f59e0b;" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M19 21H9a2 2 0 01-2-2V5a2 2 0 012-2h7l5 5v11a2 2 0 01-2 2z" />
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 3v5h5" />
                        </svg>
                ...
                <a href="{{ route('admin.blogs.trash') }}">
                    <div class="stat-card-modern">
                        ...
                        <!-- DELETED / RED -->
                        <div class="stat-icon-modern bg-red-100 text-red-600 flex items-center justify-center rounded-xl w-14 h-14"
                            style="background: #fee2e2; color: #ef4444;">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7" fill="none" viewBox="0 0 24 24"
                                style="fill: #ef4444;" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 21H9a2 2 0 01-2-2V5a2 2 0 012-2h7l5 5v11a2 2 0 01-2 2z" />
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 3v5h5" />
                            </svg>
                ...
                <table class="contacts-table-modern">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center; width: 120px;">Created By</th>
                            ...
                            @foreach ($blogs as $blog)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ \Illuminate\Support\Str::limit($blog->title, 35, '...') ?? $blog->title }}
                                    </td>
                                    <td class="text-center">
                                        {{ \Illuminate\Support\Str::limit($blog->slug, 35, '...') ?? $blog->slug }}
                                    </td>
