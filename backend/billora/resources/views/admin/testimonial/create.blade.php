                    ...
                    <div class="">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="role" class="form-input" placeholder="Enter role">
                            </div>
                            @error('role')
                                <span class="text-danger" style="color: red">{{ $message }}</span>
                            @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="company" class="form-input" placeholder="Enter company">
                            </div>
                            @error('company')
                                <span class="text-danger" style="color: red">{{ $message }}</span>  
                            @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="shop_type" class="form-input" placeholder="Enter type">
                            </div>
                            @error('shop_type')  
                                <span class="text-danger" style="color: red">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group mt-2">
                            ...
                            <textarea name="message" id="message" class="form-textarea" placeholder="Enter preview">{{ old('message') }}</textarea>
