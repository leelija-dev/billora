                    ...
                    <div class="">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-input" value="{{ $testimonial->name ?? ''}}" placeholder="Enter name">
                            </div>
                            @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="role" value="{{ $testimonial->role ?? '' }}" class="form-input" placeholder="Enter role">
                            </div>
                            @error('role')
                                <span class="text-danger" style="color: red">{{ $message }}</span>
                            @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="company" value="{{ $testimonial->company ?? '' }}" class="form-input" placeholder="Enter company">
                            </div>
                            @error('company')
                                <span class="text-danger" style="color: red">{{ $message }}</span>  
                            @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="shop_type" value="{{ $testimonial->shop_type ?? '' }}" class="form-input" placeholder="Enter type">
                            </div>
                            @error('shop_type')  
                                <span class="text-danger" style="color: red">{{ $message }}</span>
                            @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div id="starRating" class="star-container"  data-rating="{{ old('rating', $testimonial->rating) }}">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <textarea name="message" id="message" class="form-textarea" placeholder="Enter preview">{{ old('message', $testimonial->message) }}</textarea>
                        ...
                        <div class="form-actions">
                            <a href="{{ route('admin.plan-permission.index') }}"><button type="button"
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                document.getElementById('testimonialForm').addEventListener('submit', function(e) {
                    ...
                    // Name
                    if (!name.value.trim()) {
                        showError(name, "Customer name cannot be blank!");
                    }
                    if(!role.value.trim()) {
                        showError(role, "Role cannot be blank!");
                    }
                    if(!rating.value.trim()) {
                        showError(document.getElementById('starRating'), "Please provide a rating");
                    }
                    if(!company.value.trim()) {
                        showError(company, "Company name cannot be blank!");
                    }
