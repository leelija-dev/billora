    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <div class="header-left">
                ...
                <p>Update business category details and manage permissions</p>
            </div>
            ...
            <form id="planForm" action="{{ route('admin.business-types.update', $business_type->id) }}" method="POST"
                            ...
                            <div class="toggle-group">
                                <div>
                                    ...
                                    <div class="helper-text" style="margin-top: 4px;">
                                        Make this business type active in the system
                                    </div>
                                </div>
                                <label class="switch">
                ...
                <div class="form-actions">
                    <a href="{{ route('admin.business-types.index') }}">
                        <button type="button" class="btn btn-secondary" style="color:white; background-color: red;">
