    ...
    <div class="dashboard-container">
        ...
        <div class="dashboard-header">
            ...
            <div class="header-user-card">
                ...
                <div class="header-user-info">
                    <div>USER NAME: LAKSHMAN</div>
                    <div class="user-email">USER EMAIL: lakshman@billora.com</div>
                    <div class="last-login">LAST LOGIN: {{ date('d-m-Y') }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-number">2,418</div>
                <div class="stat-sub">Active: 2,284</div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-sub">Active: 892</div>
            </div>

            <!-- Card 3: Mail Sent -->
            <div class="stat-card">
                <div class="stat-header">
                    <span class="stat-title">Mail Sent</span>
                    <div class="stat-icon">📧</div>
                </div>
                <div class="stat-number">2,560</div>
                <div class="stat-sub">Delivered: 2,418</div>
            </div>
        </div>
        ...
        <div class="info-grid">
                ...
                <div class="item-list" id="customersList">
                    <div class="list-item">
                        <div>
                            ...
                            <div class="item-detail">sarah.j@email.com</div>
                        </div>
                    ...
                    <div class="list-item">
                        <div>
                            ...
                            <div class="item-detail">michael.c@email.com</div>
                        </div>
                        <span class="item-status status-active">Active</span>
                    </div>
                    <div class="list-item">
                        <div>
                            <div class="item-name">Emma Williams</div>
                            <div class="item-detail">emma.w@email.com</div>
                        </div>
                        <span class="item-status status-active">Active</span>
                    </div>
                    <div class="list-item hidden-item">
                        <div>
                            <div class="item-name">David Brown</div>
                            <div class="item-detail">david.b@email.com</div>
                        </div>
                        <span class="item-status status-pending">Pending</span>
                    </div>
                    <div class="list-item hidden-item">
                        <div>
                            <div class="item-name">Lisa Garcia</div>
                            <div class="item-detail">lisa.g@email.com</div>
                        </div>
                        <span class="item-status status-active">Active</span>
                    </div>
                </div>
                <button class="see-all-btn" onclick="toggleCustomersList()" id="customersBtn">See All Customers</button>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="item-list" id="plansList">
                    <div class="list-item">
                        <div>
                            <div class="item-name">Premium Plan</div>
                            <div class="item-detail">Annual Subscription</div>
                        </div>
                        <span class="item-status status-premium">Active</span>
                    </div>
                    <div class="list-item">
                        <div>
                            <div class="item-name">Business Pro</div>
                            <div class="item-detail">Monthly - 50 users</div>
                        </div>
                        <span class="item-status status-active">Active</span>
                    </div>
                    <div class="list-item">
                        <div>
                            <div class="item-name">Enterprise Plus</div>
                            <div class="item-detail">Custom Solution</div>
                        </div>
                        <span class="item-status status-premium">Active</span>
                    </div>
                    <div class="list-item hidden-item">
                        <div>
                            <div class="item-name">Starter Pack</div>
                            <div class="item-detail">Basic - 10 users</div>
                        </div>
                        <span class="item-status status-active">Active</span>
                    </div>
                    <div class="list-item hidden-item">
                        <div>
                            <div class="item-name">Ultimate Plan</div>
                            <div class="item-detail">Unlimited access</div>
                        </div>
                        <span class="item-status status-premium">Active</span>
                    </div>
                </div>
                <button class="see-all-btn" onclick="togglePlansList()" id="plansBtn">See All Plans</button>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="item-list" id="ordersList">
                    <div class="list-item">
                        <div>
                            <div class="item-name">#ORD-9842</div>
                            <div class="item-detail">Michael Chen - $1,299</div>
                        </div>
                        <span class="item-status status-completed">Completed</span>
                    </div>
                    <div class="list-item">
                        <div>
                            <div class="item-name">#ORD-9841</div>
                            <div class="item-detail">Sarah Johnson - $849</div>
                        </div>
                        <span class="item-status status-completed">Completed</span>
                    </div>
                    <div class="list-item">
                        <div>
                            <div class="item-name">#ORD-9840</div>
                            <div class="item-detail">Emma Williams - $2,499</div>
                        </div>
                        <span class="item-status status-completed">Completed</span>
                    </div>
                    <div class="list-item hidden-item">
                        <div>
                            <div class="item-name">#ORD-9839</div>
                            <div class="item-detail">David Brown - $599</div>
                        </div>
                        <span class="item-status status-completed">Completed</span>
                    </div>
                    <div class="list-item hidden-item">
                        <div>
                            <div class="item-name">#ORD-9838</div>
                            <div class="item-detail">Lisa Garcia - $1,899</div>
                        </div>
                        <span class="item-status status-processing">Processing</span>
                    </div>
                </div>
                <button class="see-all-btn" onclick="toggleOrdersList()" id="ordersBtn">See All Orders</button>
            </div>
        </div>
...
<script>
    ...
    function updateDonutLegend() {
        ...
        dataLabels.forEach((label, i) => {
            ...
            legendContainer.innerHTML += `<div class="legend-item"><div class="legend-color" style="background: ${donutColors[i]}"></div><span>${label}: ${val} (${((val / total) * 100).toFixed(1)}%)</span></div>`;
        });
    }
    updateDonutLegend();
