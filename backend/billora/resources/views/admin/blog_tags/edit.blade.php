            ...
            <form action="{{ route('admin.blog-tag.update', $tag->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div>
                                ...
                                <div class="input-wrapper">
                                    <span class="input-icon">
                                        <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
                                            <path
                                                d="M20.59 13.41 11 3H4v7l9.59 9.59a2 2 0 0 0 2.82 0l4.18-4.18a2 2 0 0 0 0-2.82zM7.5 8A1.5 1.5 0 1 1 9 6.5 1.5 1.5 0 0 1 7.5 8z" />
                                        </svg>
                                    </span>
                    ...
                    <div class="form-actions">
                        <a href="{{ route('admin.blog-tag.index') }}" class="btn btn-secondary" style="color:white; background-color:red;">
