                    ...
                    <div class="header-search">
                        <div class="search-wrapper">
                            ...
                            <form action="{{ route('admin.blog-tag.index') }}" method="GET" style="flex: 1;">
                                <input type="text" name="search" placeholder="Search by tag name and slug..."
                                    ...
                                    <td colspan="6" class="empty-state-modern">
                                        ...
                                        @if (request('search'))
                                            ...
                                            <p style="font-size: 12px; margin-top: 8px;">
                                                <a href="{{ route('admin.blog-tag.index') }}" style="color: #2563eb;">Clear
                                                    search</a>
                                            </p>
                                        @else
                ...
                @if ($tags->hasPages())
                    <div class="pagination-modern">
                        <div class="pagination-info">
                            ...
                            of <strong>{{ $tags->total() }}</strong> results
                        </div>
                        <div>
