...
<div class="main-content">
    ...
    <div class="modern-page-header">
        <div class="header-left">
            ...
            <p>Add a new permission to control user access and features</p>
        </div>
    ...
    <div class="form-container-modern">
        <form id="planForm" action="{{ route('admin.plan-permission.store') }}" method="POST" enctype="multipart/form-data" novalidate>
            @csrf
            ...
            <div class="form-grid-modern">
                ...
                <div class="form-group-modern">
                    ...
                    @enderror
                    <div class="helper-text-modern">
                        <span>💡</span> Use lowercase with dashes (e.g., manage-users)
                    </div>
                </div>
