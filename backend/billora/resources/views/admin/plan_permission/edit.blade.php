    ...
    <div class="main-content">
        ...
        <div class="form-container">
            <form id="planForm" action="{{ route('admin.plan-permission.update', $planPermission->id) }}" method="POST" enctype="multipart/form-data"
                novalidate>
                @csrf
                ...
                <div class="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="name" class="form-input with-icon"
                                placeholder="Enter permission name " value="{{ $planPermission->permission_name ?? ''}}"
                                required>
                            @error('name')
                    ...
                    <div class="form-group mt-2">
                        ...
                        <textarea name="description" id="description" class="form-textarea"
                            placeholder="Enter permission description">{{ $planPermission->description ?? '' }}</textarea>
