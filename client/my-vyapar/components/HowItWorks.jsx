    ...
    return (
        <div className="py-12 sm:py-16 md:py-20 lg:py-[60px] bg-gradient-to-br from-[#f8fafc] to-[#f1f5f9] min-h-screen font-sans overflow-x-hidden">
            <Container> {/* Added Container here - removes all outer padding */}
                ...
                {/* Top CTA Card - removed px-2 sm:px-5 */}
                <div className="max-w-[900px] mx-auto mb-8 sm:mb-10 md:mb-12 lg:mb-16 animate-[fadeInUp_0.8s_ease-out_0.3s_both]">
                ...
                {/* Steps Section - removed outer max-w and px classes */}
                <div className="w-full relative">
                    <div className="relative flex flex-col lg:flex-row justify-between items-stretch gap-6 sm:gap-6 md:gap-8 lg:gap-[30px] py-6 sm:py-8 md:py-12 lg:py-[60px]">
