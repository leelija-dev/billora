        ...
        <div className="py-12 sm:py-16 md:py-20 lg:py-[60px] bg-gradient-to-br from-[#f8fafc] to-[#f1f5f9] min-h-screen font-sans overflow-x-hidden">
            <Container>
                ...
                <div className="text-center mb-8 sm:mb-10 md:mb-12 lg:mb-[60px] px-4 sm:px-0">
                    ...
                    <p className="text-[#475569] text-base sm:text-base md:text-sm lg:text-xl max-w-[600px] mx-auto mt-4 sm:mt-6 animate-[fadeInUp_0.8s_ease-out_0.2s_both] leading-relaxed px-2">
                        {/* Tablet: md:text-sm (14px) instead of md:text-lg (18px) */}
                        Get started with Billora in three simple steps
                    </p>
                </div>

                {/* Top CTA Card - Optimized for tablet */}
                <div className="max-w-[900px] mx-auto mb-8 sm:mb-10 md:mb-12 lg:mb-16 animate-[fadeInUp_0.8s_ease-out_0.3s_both] px-4 sm:px-0">
                    <div className="bg-gradient-to-br from-white to-[#f8fafc] rounded-lg sm:rounded-xl md:rounded-2xl lg:rounded-[20px] p-6 sm:p-6 md:p-6 lg:p-[25px_35px] shadow-[0_15px_30px_rgba(0,0,0,0.05)] flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-4 md:gap-6 border border-[#3b82f61A] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_35px_rgba(59,130,246,0.12)] hover:border-[#3b82f633]">
                        <div className="flex-1 text-center sm:text-left w-full sm:w-auto">
                            <h2 className="text-xl sm:text-xl md:text-lg lg:text-[22px] font-bold text-[#1e293b] mb-3 sm:mb-2.5 md:mb-3 tracking-[-0.3px]">
                ...
                <div className="w-full relative px-4 sm:px-0">
                    <div className="relative flex flex-col lg:flex-row justify-between items-stretch gap-8 sm:gap-6 md:gap-6 lg:gap-[30px] py-6 sm:py-8 md:py-10 lg:py-[60px]">
                        ...
                        {/* Step Cards - Optimized for tablet */}
                        {steps.map((step, index) => (
                            ...
                            >
                                <div
                                    className="bg-white rounded-lg sm:rounded-xl md:rounded-xl lg:rounded-[30px] p-6 sm:p-6 md:p-6 lg:p-[45px_30px_35px] shadow-[0_10px_25px_rgba(0,0,0,0.06)] md:shadow-[0_15px_30px_rgba(0,0,0,0.06)] lg:shadow-[0_20px_40px_rgba(0,0,0,0.08)] relative transition-all duration-400 ease-[cubic-bezier(0.34,1.56,0.64,1)] border border-black/5 h-full w-full flex flex-col items-center text-center hover:-translate-y-2 hover:scale-105 hover:shadow-[0_30px_60px_rgba(59,130,246,0.15)] group"
                                    style={{ '--step-color': step.color }}
                                >
                                    {/* Circle Number Badge */}
                                    <div
                                        className="absolute -top-5 sm:-top-6 md:-top-5 lg:-top-5 left-1/2 lg:left-6 transform lg:transform-none -translate-x-1/2 lg:translate-x-0 w-10 h-10 sm:w-12 sm:h-12 md:w-10 md:h-10 lg:w-[50px] lg:h-[50px] rounded-full flex items-center justify-center text-white font-bold text-base sm:text-lg md:text-sm lg:text-xl shadow-[0_8px_16px_rgba(0,0,0,0.1)] md:shadow-[0_8px_16px_rgba(0,0,0,0.1)] lg:shadow-[0_10px_20px_rgba(0,0,0,0.1)] border-3 border-white z-[3] animate-[pulse_2s_infinite] flex-shrink-0"
                                    ...
                                    {/* Icon Circle */}
                                    <div
                                        className="w-16 h-16 sm:w-16 sm:h-16 md:w-14 md:h-14 lg:w-[90px] lg:h-[90px] rounded-full flex items-center justify-center mb-4 sm:mb-4 md:mb-3 lg:mb-6 text-3xl sm:text-3xl md:text-2xl lg:text-5xl transition-all duration-300 group-hover:scale-110 group-hover:rotate-5 mt-4 sm:mt-4 md:mt-4 lg:mt-6"
                                    ...
                                    {/* Title */}
                                    <h3 className="text-xl sm:text-lg md:text-base lg:text-2xl font-bold text-[#1e293b] mb-3 sm:mb-3 md:mb-2 lg:mb-5 relative inline-block after:content-[''] after:absolute after:bottom-[-6px] sm:after:bottom-[-8px] md:after:bottom-[-4px] lg:after:bottom-[-8px] after:left-1/2 after:-translate-x-1/2 after:w-6 sm:after:w-8 md:after:w-6 lg:after:w-10 after:h-[2px] sm:after:h-[3px] md:after:h-[2px] lg:after:h-[3px] after:bg-[var(--step-color)] after:opacity-50 after:transition-all after:duration-300 group-hover:after:w-12 md:group-hover:after:w-8 lg:group-hover:after:w-[60px]">
                                        {/* Tablet: md:text-base (16px) instead of md:text-2xl (24px) */}
                                        {step.title}
                                    </h3>

                                    {/* Description */}
                                    <p className="text-sm sm:text-sm md:text-xs lg:text-[15px] text-[#475569] leading-relaxed sm:leading-[1.5] md:leading-[1.4] lg:leading-[1.7] mb-4 sm:mb-4 md:mb-3 lg:mb-6 flex-grow px-2">
                                        {/* Tablet: md:text-xs (12px) instead of md:text-[15px] */}
                                        {step.description}
                                    </p>

                                    {/* Button */}
                                    <button
                                        className="px-6 sm:px-6 md:px-4 lg:px-[30px] py-3 sm:py-2 md:py-1.5 lg:py-3 border-none rounded-full text-white font-semibold text-sm sm:text-sm md:text-xs lg:text-[15px] cursor-pointer transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] w-full max-w-[160px] sm:max-w-[160px] md:max-w-[130px] lg:max-w-[180px] mt-2 sm:mt-3 md:mt-2 lg:mt-6 relative overflow-hidden hover:-translate-y-1 hover:scale-105 hover:shadow-[0_10px_25px_rgba(0,0,0,0.2)] active:translate-y-0 active:scale-95 before:content-[''] before:absolute before:top-0 before:left-[-100%] before:w-full before:h-full before:bg-gradient-to-r before:from-transparent before:via-white/20 before:to-transparent before:transition-all before:duration-500 hover:before:left-full"
                                        style={{
