...
const Testimonials = () => {
  ...
  return (
    <section 
      className="py-12 sm:py-16 md:py-20 lg:py-24 bg-[#f8fafc] overflow-hidden font-sans"
      onMouseEnter={() => setIsHovered(true)}
      onMouseLeave={() => setIsHovered(false)}
    >
      <Container> {/* Added Container here - removes outer padding */}
        <div className="w-full text-center">
          {/* Header - removed px-2 */}
          <SectionTitle 
            title="They succeeded online, now it's your turn"
          />
          <p className="text-slate-500 text-base sm:text-lg mb-8 sm:mb-12 md:mb-16">
