        ...
        <div className="relative bg-[#0f172a] rounded-[40px] pt-[100px] pb-[100px] px-[20px] md:px-[40px] max-w-[1000px] mx-auto shadow-[0_20px_50px_rgba(0,0,0,0.4)] border border-white/10 overflow-visible">
          ...
          <div className="flex justify-center gap-3 md:gap-5 mb-12 flex-wrap relative z-20">
            {["Easy to Use", "Collaborative", "Activity Stream"].map((pill) => (
              <span key={pill} className="px-6 py-3 bg-white/5 backdrop-blur-md border border-white/10 rounded-full text-white/90 font-medium text-xs md:text-sm">
                {pill}
              </span>
            ))}
          </div>
             ...
             <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
                <div className="flex-1 text-center md:text-left">
                   <div className="flex items-center gap-2 mb-4 justify-center md:justify-start">
                      ...
                      <span className="font-bold text-slate-800">Billora Premium</span>
                   </div>
                   <h3 className="text-2xl md:text-3xl font-extrabold text-slate-900 mb-2">GST Billing Software</h3>
                   <p className="text-slate-500 mb-6 text-sm">Automate your invoicing and inventory in seconds.</p>
