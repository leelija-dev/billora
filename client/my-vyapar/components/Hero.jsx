    ...
    <div className="overflow-x-hidden font-sans">
      ...
      <section className="relative z-10 min-h-[100vh] flex items-center pb-32 pt-10 bg-gradient-to-br from-slate-50 via-indigo-50 to-sky-100 overflow-hidden">
        ...
        <style>{`
          ...
          .heroic-slide-phone { animation: heroicSlidePhone 1.3s cubic-bezier(0.34, 1.56, 0.64, 1) 0.2s forwards; }
          .heroic-slide-badge1 { animation: fadeInUp 1s ease-out 0.4s forwards, custom-bounce 3s ease-in-out 1.4s infinite; opacity: 0; }
          .heroic-slide-badge2 { animation: fadeInUp 1s ease-out 0.6s forwards, custom-bounce 3.2s ease-in-out 1.6s infinite; opacity: 0; }
          .heroic-slide-badge3 { animation: fadeInUp 1s ease-out 0.8s forwards, custom-bounce 2.8s ease-in-out 1.8s infinite; opacity: 0; }
        ...
        <Container>
          <div className="relative z-30 w-full flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
            ...
            {/* --- IMAGE CONTAINER (FIXED PC MODEL) --- */}
            <div className="flex-1 relative min-h-[480px] w-full max-w-[650px] mt-12 lg:mt-0 flex flex-col items-center">
              ...
              <div className="relative w-full z-10 heroic-slide-pc">
                ...
                <div className="relative aspect-[16/10] bg-slate-900 rounded-[20px] p-2.5 shadow-2xl border border-slate-700/50">
                  <div className="w-full h-full bg-slate-800 rounded-xl overflow-hidden relative shadow-inner">
                    ...
                    <Image src="/image/desktop.png" alt="PC Dashboard" fill className="object-cover" priority />
                  </div>
                </div>
              ...
              {/* Floating Mobile Image (Layered over PC) */}
              <div className="absolute left-0 bottom-4 w-[125px] h-[250px] bg-slate-800 rounded-[35px] p-2 shadow-2xl z-30 hidden sm:block heroic-slide-phone border border-slate-700">
                <div className="w-full h-full bg-slate-900 rounded-[30px] overflow-hidden relative border-2 border-slate-800">
                  <Image src="/image/Mobile.png" alt="Mobile App" fill className="object-cover" />
                </div>
              </div>

              {/* Badges in Fixed Positions */}
