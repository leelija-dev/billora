...
import { 
  FaUser, FaPhone, FaEnvelope, FaPaperPlane, FaMapMarkerAlt, 
...
import { MdPhone, MdEmail, MdLocationOn, MdVerified, MdBusinessCenter } from 'react-icons/md';
            ...
            <div className="relative bg-white rounded-2xl sm:rounded-3xl shadow-2xl p-5 sm:p-6 md:p-7 lg:p-8 xl:p-8 2xl:p-10 border border-gray-100">
              ...
              <form className="space-y-4 sm:space-y-5" onSubmit={handleSubmit} noValidate>
                ...
                <div className="group">
                  ...
                  <p className="text-gray-400 text-xs mt-1 ml-1">Enter 10-digit mobile number</p>
                </div>
