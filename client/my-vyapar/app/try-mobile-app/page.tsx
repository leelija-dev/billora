...
export const metadata = {
  title: 'Try Mobile App - Vyapar | GST Billing on the Go',
  description: 'Download Vyapar mobile app for Android and iOS. Create invoices, track inventory, and manage your business anytime, anywhere.',
};
