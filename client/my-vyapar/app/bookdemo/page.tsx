...
export default function BookDemoPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-[#eef2ff] via-[#e0e7ff] to-[#dbeafe] px-6 py-24">
      ...
      <button
        onClick={() => router.push("/")}
        className="fixed top-6 left-6 flex items-center gap-2 px-4 py-2 bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105 text-[#2d236b] font-medium z-50"
      >
        <Home className="text-[#5b5bd6]" size={20} />
