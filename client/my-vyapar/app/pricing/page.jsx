        ...
        if (data.status === true && data.data) {
          ...
          const transformedPlans = allPlans.map((plan, index) => {
            ...
            return {
              ...
              color: index === 1 ? '#8b5cf6' : '#000000', // Make second plan purple (optional)
              buttonText: plan.name === 'Enterprise' || plan.name === 'Enterprize Plan' ? 'Contact Sales' : `Start ${plan.name}`,
              popular: index === 1, // Make the second plan popular (optional)
