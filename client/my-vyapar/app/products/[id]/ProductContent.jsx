...
const ProductsContent = () => {
  ...
  useEffect(() => {
    if (effectiveUserId && token) {
      ...
      console.log("✅ User context set in store (no token):", {
  ...
  const fetchAllProductsForCategories = useCallback(async () => {
    ...
    try {
      ...
      console.log(
        `✅ Loaded ${result.products.length} products for category counts`,
      );
    } catch (error) {
  ...
  <div className="flex items-center justify-between px-4 py-3">
    ...
    <button
      ...
      className="flex items-center justify-center w-11 h-11 rounded-2xl bg-white border border-gray-200 shadow-sm hover:bg-blue-50 hover:border-blue-200 hover:shadow-md transition-all duration-200 active:scale-95"
    >
    ...
    <div className="flex items-center gap-3">
      ...
      <button
        ...
        className="flex items-center justify-center w-11 h-11 rounded-2xl bg-white border border-gray-200 shadow-sm hover:bg-green-50 hover:border-green-200 hover:shadow-md transition-all duration-200 active:scale-95"
      >
      ...
      <button
        ...
        className="relative flex items-center justify-center w-11 h-11 rounded-2xl bg-blue-600 shadow-md hover:bg-blue-700 transition-all duration-200 active:scale-95"
      >
        <FiShoppingCart className="w-5 h-5 text-white" />

        {getCartItemCount() > 0 && (
          <span className="absolute -top-1 -right-1 min-w-[20px] h-5 px-1 bg-red-500 text-white text-[10px] font-semibold rounded-full flex items-center justify-center border-2 border-white">
            {getCartItemCount()}
          </span>
        )}
      </button>
