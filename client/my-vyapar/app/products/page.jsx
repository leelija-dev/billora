  ...
  <div className="bg-gradient-to-br from-blue-50 to-white p-3 rounded-lg border border-blue-100 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 380px)' }}>
    ...
    <div className="space-y-3">
      {cart.map((item) => {
        ...
        const discountAmount = (basePrice * discountPercent) / 100;
        const gstAmount = parseFloat((basePrice - discountAmount) * gstPercent) / 100;
        const finalPrice = basePrice + gstAmount - discountAmount;
        const itemTotal = basePrice * quantity;
        
        const totalGstForItem = parseFloat(gstAmount) * quantity;
        const totalDiscountForItem = parseFloat(discountAmount) * quantity;
            ...
            <div className="space-y-0.5 pl-2">
              ...
              {gstPercent > 0 && (
                <div className="flex justify-between text-xs">
                  ...
                  <span className="text-gray-600">+ ₹{totalGstForItem.toFixed(2)}</span>
                </div>
              )}
