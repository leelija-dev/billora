                ...
                <form onSubmit={handleSearch} className="max-w-2xl mx-auto">
                  <div className="flex flex-col sm:flex-row gap-3">
                    <div className="flex-1 relative group">
                      <div className={`absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-all duration-300 ${isFocused ? 'text-blue-600' : 'text-slate-400'}`}>
                ...
                {summary && (
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-10">
                    <div className="group bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-5 border border-slate-100 hover:border-blue-200">
                      ...
                      <p className="text-text-xs text-slate-500 mb-1">Total Orders</p>
                      <p className="text-h3-sm font-bold text-slate-800">{summary.total_orders}</p>
                    </div>
                    ...
                    <div className="group bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-5 border border-slate-100 hover:border-emerald-200">
                      ...
                      <p className="text-text-xs text-slate-500 mb-1">Total Spent</p>
                      <p className="text-h3-sm font-bold text-slate-800">₹{formatPrice(summary.total_spent)}</p>
                    </div>
                    ...
                    <div className="group bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-5 border border-slate-100 hover:border-purple-200">
                      ...
                      <p className="text-text-xs text-slate-500 mb-1">Average Order</p>
                      <p className="text-h3-sm font-bold text-slate-800">₹{formatPrice(summary.average_order_value)}</p>
                    </div>
                    ...
                    <div className="group bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-5 border border-slate-100 hover:border-orange-200">
                      ...
                      <p className="text-text-xs text-slate-500 mb-1">Last Order</p>
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="bg-slate-100 px-3 py-1.5 rounded-full">
                    <span className="text-text-xs text-slate-600">
                      ...
                      {orders.reduce((sum, order) => sum + order.items_count, 0)} items total
                    </span>
                  </div>
                </div>
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                          <div className="flex-1">
                            <div className="flex flex-wrap items-center gap-3 mb-3">
                              ...
                              <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-text-xs font-medium border ${getStatusColor(order.order_status)}`}>
                          ...
                          <div className="text-left lg:text-right">
                            ...
                            <p className="text-text-xs text-slate-500 mt-1">{order.items_count} items</p>
            ...
            {searchPerformed && !loading && orders.length === 0 && !error && (
              <div className="animate-fade-in-up">
                <div className="bg-white rounded-2xl shadow-xl border border-slate-100 p-12 md:p-16 text-center">
                  ...
                  <h3 className="text-h3-sm font-bold text-slate-800 mb-3">No orders found</h3>
                  <p className="text-p-xs text-slate-500 mb-2">
                    No orders found for mobile number: <span className="font-semibold text-slate-700">{mobileNumber}</span>
                  </p>
            ...
            {!searchPerformed && (
              <div className="animate-fade-in-up">
                <div className="bg-white rounded-2xl shadow-xl border border-slate-100 p-12 md:p-16 text-center">
                  ...
                  <h3 className="text-h3-sm font-bold text-slate-800 mb-3">Customer Order History</h3>
                  <p className="text-p-xs text-slate-500 mb-2">
                    Enter a customer's mobile number above to view their complete order history
                  </p>
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden">
              ...
              <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 p-6 md:p-8">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  ...
                  <span className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-text-sm font-semibold backdrop-blur-sm bg-white/20 text-white border border-white/30 w-fit`}>
              ...
              <div className="p-6 md:p-8 border-b border-slate-100">
                <h3 className="text-h4-xs font-bold text-slate-800 mb-5">Order Information</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                  <div className="p-4 bg-slate-50 rounded-xl">
                    <p className="text-text-xs text-slate-500 mb-1">Customer Name</p>
                  ...
                  <div className="p-4 bg-slate-50 rounded-xl">
                    <p className="text-text-xs text-slate-500 mb-1">Mobile Number</p>
                    <p className="font-semibold text-slate-800 flex items-center gap-2">
                      <FiPhone className="w-4 h-4 text-slate-400" />
                  ...
                  <div className="p-4 bg-slate-50 rounded-xl">
                    <p className="text-text-xs text-slate-500 mb-1">Order Date</p>
                    <p className="font-semibold text-slate-800 flex items-center gap-2">
                      <FiCalendar className="w-4 h-4 text-slate-400" />
                  ...
                  <div className="p-4 bg-slate-50 rounded-xl">
                    <p className="text-text-xs text-slate-500 mb-1">Payment Mode</p>
              ...
              {/* Order Items */}
              <div className="p-6 md:p-8 border-b border-slate-100">
                <h3 className="text-h4-xs font-bold text-slate-800 mb-5">Order Items</h3>
                <div className="space-y-3">
                  {selectedOrder.items?.map((item, index) => (
                    <div key={index} className="flex items-center justify-between py-4 border-b border-slate-100 last:border-0 hover:bg-slate-50 transition-colors px-3 rounded-lg">
                      <div className="flex-1">
                        <p className="font-semibold text-slate-800 text-p-xs">{item.product_name}</p>
              ...
              <div className="p-6 md:p-8 bg-gradient-to-br from-slate-50 to-slate-100">
                <div className="max-w-md ml-auto">
                  <h3 className="text-h4-xs font-bold text-slate-800 mb-4">Order Summary</h3>
                  <div className="space-y-3">
                    <div className="flex justify-between text-p-xs">
                      <span className="text-slate-600">Subtotal</span>
                      <span className="font-medium text-slate-800">₹{formatPrice(selectedOrder.total_amount)}</span>
                    </div>
                    ...
                    {selectedOrder.gst_amount > 0 && (
                      <div className="flex justify-between text-p-xs">
                        ...
                        <span className="font-medium text-slate-800">₹{formatPrice(selectedOrder.gst_amount)}</span>
                      </div>
                    )}
