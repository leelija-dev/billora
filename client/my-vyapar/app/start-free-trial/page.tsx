...
/>
          ...
          <motion.div
            ...
            className="fixed inset-0 z-50 flex items-center justify-center px-4 py-10 overflow-y-auto bg-gradient-to-br from-slate-50 via-indigo-50 to-sky-100"
          >

            {/* Close */}
            <button
              onClick={handleClose}
              className="absolute top-6 right-6 p-2 rounded-full bg-white shadow hover:bg-gray-100"
            >
            ...
            <div className="w-full max-w-5xl mx-auto">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:gap-12 bg-white/70 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden border border-white">

                {/* LEFT SIDE */}

                <div className="lg:w-1/2 p-10 bg-gradient-to-br from-indigo-100 to-sky-100">
